# Generated by Powerlevel10k configuration wizard on 2020-06-05 at 20:44 -04.
...
# full frame, darkest-ornaments, compact, many icons, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_RUBY_BACKGROUND=4
